...
- [~] **Phase 5** — consolidation du vestige + audit offline différé. Découpée (un commit chacun) :
  ...
  - [ ] **5b — Audit offline différé** : mémoriser les consultations de docs du coffre faites **offline** (4b) et les rejouer dans `vault_access_log` à la reconnexion. *(Reprise des docs existants : sans objet — Yves ne garde que des docs chiffrés.)*
