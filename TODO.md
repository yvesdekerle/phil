...
- [ ] V07c — Mes voyages : les voyages passés reprennent le **même format de carte que les actifs** mais en grisé (photo désaturée, textes éteints), dans la même grille 2 colonnes — la rangée pleine largeur était « bizarre ». `TripPastRow` supprimé.
