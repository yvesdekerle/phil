...
async function main() {
  ...
  const events: Ev[] = [
    ...
    {
      type: "ACTIVITY",
      title: "Château de Labourdonnais — domaine et vergers",
      starts: mu("2026-11-13", "14:30"),
      ends: mu("2026-11-13", "16:30"),
      loc: "Mapou",
      lat: -20.095,
      lng: 57.611,
    ...
    {
      type: "ACTIVITY",
      title: "Baignade au coucher du soleil — Mont Choisy",
      starts: mu("2026-11-13", "17:00"),
      ends: mu("2026-11-13", "18:45"),
